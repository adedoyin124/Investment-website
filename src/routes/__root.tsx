  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <p className="font-display text-xs uppercase tracking-[0.3em] text-primary">404</p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "NovaVest — Modern Wealth & Real Estate Investing" },
      { name: "description", content: "NovaVest is a premium wealth and real estate investment platform with daily ROI plans, tokenized property shares, and a beautifully simple dashboard." },
      { property: "og:title", content: "NovaVest — Modern Wealth & Real Estate Investing" },
      { property: "og:description", content: "Build a diversified portfolio across investment plans and institutional-grade real estate." },
